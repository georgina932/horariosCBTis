...
if ($id !== null && is_numeric($id)) {
    ...
    $sql = "SELECT id, nombre, clave, carga, descarga, asignadas, entrada, salida FROM docentes WHERE id = ?";
    ...
    if ($stmt) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo json_encode(array('error' => 'Docente no encontrado'));
        }
    ...
    echo json_encode(array('error' => 'ID de docente no válido'));
}
